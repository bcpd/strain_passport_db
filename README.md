...
*4. Patent search*
US patents records (2000-present) are searched and parsed for each species-level MAG (`patent_search.R`).
Input: Taxonomy table from the initial pipeline (gtdbtk.bac120.summary.tsv)
